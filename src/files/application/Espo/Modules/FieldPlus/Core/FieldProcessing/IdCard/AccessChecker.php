...
class AccessChecker
{
    ...
    public function checkEdit(User $user, IdCard $idCard, Entity $excludeEntity): bool
    {
        /** @var Repository $repository */
        $repository = $this->entityManager->getRepository('IdCard');

        $entityWithSameNumberList = $repository->getEntityListByPhoneNumberId($idCard->getId(), $excludeEntity);
