...
class Loader implements LoaderInterface
{
    ...
    public function process(Entity $entity, Params $params): void
    {
        ...
        if (!$entityDefs->hasField('idCard')) {
            return;
        }

        if ($entityDefs->getField('idCard')->getType() !== 'idCard') {
            return;
        }
        ...
        $idCardData = $repository->getIdCardData($entity);

        $entity->set('idCardData', $idCardData);
        $entity->setFetched('idCardData', $idCardData);
    }
}
